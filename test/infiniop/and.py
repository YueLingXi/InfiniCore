...
# _TENSOR_DTYPES = [InfiniDtype.F16, InfiniDtype.F32, InfiniDtype.F64, InfiniDtype.BF16,InfiniDtype.BOOL]
_TENSOR_DTYPES = [InfiniDtype.F16, InfiniDtype.F32,  InfiniDtype.BF16]
# _TENSOR_DTYPES = [InfiniDtype.F16, INFINI_DTYPE_F32, INFINI_DTYPE_F64, INFINI_DTYPE_BF16,InfiniDtype.BOOL]
...
def test(
    ...
    and_op(c.torch_tensor(), a.torch_tensor(), b.torch_tensor())
    ...
    if PROFILE:
        # fmt: off
        profile_operation("PyTorch", lambda: and_op(c.torch_tensor(), a.torch_tensor(), b.torch_tensor()), device, NUM_PRERUN, NUM_ITERATIONS)
